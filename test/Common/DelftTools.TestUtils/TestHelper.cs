...
namespace DelftTools.TestUtils
{
    public class TestHelper
    {
        ...
        {
            AssertLogMessagesAreGenerated(action, new[] { message }, expectedLogMessageCount);
        }
        ...
        {
            AssertLogMessagesAreNotGenerated(action, new[] { unwantedMessage }, expectedLogMessageCount);
        }
