...
namespace DelftTools.Functions.Tests
{
    ...
    public class FunctionTest
    {
        ...
        [Test]
        public void EventBubbleShouldNotHappenMultipleTimes()
        {
            IFunction function = new Function
                                     {
                                         Arguments =
            ...
            int called = 0;
            ((INotifyPropertyChanged) function).PropertyChanged += (s, e) => called++;

            ((IEditableObject) function.Arguments[0].Values).BeginEdit(new DefaultEditAction("test"));
...
//            Assert.AreEqual(1,functionPropChangedCount);
        ...
        public void Set10kFunctionValues2D()
        {
            ...
            TestHelper.AssertIsFasterThan(115, action);
        }
        ...
        public void Set10kFunctionValues2D_SetFirstDimensionAsLast()
        {
            ...
            TestHelper.AssertIsFasterThan(100, action);
        }
        ...
        public void SettingValuesUsingSetValuesShouldBeFastForSingleComponentFunctions()
        {
            ...
            TestHelper.AssertIsFasterThan(105, () =>
            {
                for (int i = 0; i < 1000; i++)
                {
        ...
        public void SetALotOfValuesWithoutEvents()
        {
            ...
            TestHelper.AssertIsFasterThan(3150, action);
        ...
        public void SetALotOfValuesWithEvents()
        {
            ...
            TestHelper.AssertIsFasterThan(4300, () =>
                                                    {
                                                        x.SetValues(xValues);
                                                        y.SetValues(yValues);
                                                    });
        ...
        [Test]
        [Category(TestCategory.WorkInProgress)]
        [ExpectedException(typeof(FormatException),ExpectedMessage = "All Arguments values must be unique.")]
        public void FunctionWithMultipleIdenticalArguments()
        {
            ...
            arg1.SetValues(new[] {1.0, 1.0, 2.0, 3.0, 5.5});
        }
