...
namespace SharpMapTestUtils
{
    ...
    {       
        ...
        public static INetwork CreateMockNetwork()
        {
            ...
            node1.IncomingBranches = new EventedList<IBranch>();
            node2.IncomingBranches = new EventedList<IBranch> { branch1 };
            node3.IncomingBranches = new EventedList<IBranch> { branch2 };

            node1.OutgoingBranches = new EventedList<IBranch> { branch1 };
            node2.OutgoingBranches = new EventedList<IBranch> { branch2 };
            node3.OutgoingBranches = new EventedList<IBranch>();
