...
namespace NetTopologySuite.Extensions.Tests.Coverages
{
    ...
    {
        internal static INetwork GetSnakeNetwork(bool generateIDs, int numberOfBranches)
        {
        ...
        internal static INetwork GetSnakeNetwork(bool generateIDs, params Point[] points)
        {
        ...
        public void GetLocationsForSegmentInCorrectOrder()
        {
            ...
            var segmentUp = new NetworkSegment { Branch = branch, Chainage = 30, Length = 40 };
