...
namespace SharpMap.UI.Tests.Tools
{
    ...
    public class MapToolExample
    {
        ...
        public void MapToolMessageBoxEnabledTest()
        {
            ...
            var mapControl = new MapControl() { Map = new Map(new Size(100, 100)), AllowDrop = false };
    ...
    public class MapToolMessageBox: IMapTool
    {
        ...
        public void OnMouseDown(GeoAPI.Geometries.Coordinate worldPosition, System.Windows.Forms.MouseEventArgs e)
        {

        }

        public void OnMouseMove(GeoAPI.Geometries.Coordinate worldPosition, System.Windows.Forms.MouseEventArgs e)
        {
        ...
        public void OnMouseWheel(GeoAPI.Geometries.Coordinate worldPosition, System.Windows.Forms.MouseEventArgs e)
        {
        ...
        public void OnMouseHover(GeoAPI.Geometries.Coordinate worldPosition, EventArgs e)
        {
        ...
        public void OnMapLayerRendered(System.Drawing.Graphics g, ILayer layer)
        {
        ...
        public void OnBeforeContextMenu(System.Windows.Forms.ContextMenuStrip menu, GeoAPI.Geometries.Coordinate worldPosition)
        {
        ...
        public ILayer GetLayerByFeature(GeoAPI.Extensions.Feature.IFeature feature)
        {
