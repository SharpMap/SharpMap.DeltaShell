...
namespace DelftTools.Functions
{
    ...
    /// 	</example>
    /// </summary>
    public interface IFunction : INotifyCollectionChange, INameable, IUnique<long>, IManualCloneable, IEditableObject
    {
        /// <summary>
        ...
        /// <see cref="FunctionExtensions.GetAllComponentValues"/> has been introduces to solve this issues temporarily.
        ...
        ///   Precondition: The size of the subspace described by the collection of <see cref="IVariableFilter"/> cannot be 0
        /// </param>
