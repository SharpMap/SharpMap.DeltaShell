...
namespace DelftTools.Units.Generics
{
        ...
        where T : IComparable
    {
        ...
        /// when <see cref="DefaultValue"/>, <see cref="Value"/>, <see cref="Parameter.MinValidValue"/> or <see cref="Parameter.MaxValidValue"/> 
        /// do not inherit from <see cref="ICloneable"/>, are not null, or are not a value type.
        /// </exception>
