...
namespace NetTopologySuite.Extensions.Coverages
{
    ...
    public abstract class Coverage : Function, ICoverage
    {
        ...
        public abstract object Evaluate(Coordinate coordinate);
        ...
        /// <returns></returns>
        public abstract T Evaluate<T>(Coordinate coordinate);
        ...
        public abstract object Evaluate(Coordinate coordinate, DateTime? time);
        ...
        public virtual IFunction GetTimeSeries(Coordinate coordinate)
        {
