...
namespace NetTopologySuite.Extensions.Coverages
{
    ...
    public class NetworkCoverage : Coverage, INetworkCoverage
    {
        ...
        private IBranch TryGetExactBranchMatch(Coordinate coordinate)
        {
            foreach (var branch in Network.Branches)
            {
        ...
        public INetworkLocation GetNearestNetworkLocation(Coordinate coordinate)
        {
        ...
        /// <returns></returns>
        private INetworkLocation GetNearestNetworkLocation(Coordinate coordinate, IBranch branchItMustBeOn = null)
        {
