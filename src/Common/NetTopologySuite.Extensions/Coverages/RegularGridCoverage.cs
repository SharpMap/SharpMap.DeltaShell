...
namespace NetTopologySuite.Extensions.Coverages
{
    public class RegularGridCoverage : Coverage, IRegularGridCoverage
    {
        ...
        public void Resize(int sizeX, int sizeY, double deltaX, double deltaY, Coordinate origin)
        {
        ...
        public void Resize(int sizeX, int sizeY, double deltaX, double deltaY, Coordinate origin, bool setDefaultComponentValues)
        {
