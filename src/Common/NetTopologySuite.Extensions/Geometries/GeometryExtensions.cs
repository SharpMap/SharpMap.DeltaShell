...
namespace NetTopologySuite.Extensions.Geometries
{
    public static class GeometryExtensions
    {
        ...
        /// <returns></returns>
        public static IPolygon ToPolygon(this IEnumerable<Coordinate> coordinates)
        {
        ...
        /// <param name="coordinates"></param>
        /// <returns></returns>
        public static ILineString ToLineString(this IEnumerable<Coordinate> coordinates)
        {
