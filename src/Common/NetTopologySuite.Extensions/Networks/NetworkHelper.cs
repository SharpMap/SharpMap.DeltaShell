    ...
    public static class NetworkHelper
    {
        ...
        public static IBranch GetNearestBranch(IEnumerable<IBranch> branches, IGeometry geometry, double tolerance)
        {
            ...
            foreach (var branch in branches)
            {
                ...
                var branchEnvelope = (Envelope)(branch.Geometry.EnvelopeInternal.Clone());
                var featureEnvelope = (Envelope)(geometry.EnvelopeInternal.Clone());
        ...
        /// <returns></returns>
        private static INode GetExistingOrNewNodeFromNetwork(INetwork network, Coordinate coordinate)
        {
