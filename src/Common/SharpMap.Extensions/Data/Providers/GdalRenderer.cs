...
namespace SharpMap.Extensions.Data.Providers
{
    ...
    public class GdalRenderer : RegularGridCoverageRenderer
    {
        ...
        private void Draw(Dataset dataset, Size size, Graphics g, Envelope mapExtents, Envelope gridExtents)
        {
            ...
            int x1 = (int)geoTransform.PixelX(geoTransform.HorizontalPixelResolution < 0 ? (x1width - left) : left);
            int y1 = (int)geoTransform.PixelY(geoTransform.VerticalPixelResolution < 0 ? (y1height - top) : top);
