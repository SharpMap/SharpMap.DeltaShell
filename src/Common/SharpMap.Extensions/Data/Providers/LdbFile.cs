...
namespace SharpMap.Extensions.Data.Providers
{
    ...
    public class LdbFile : Unique<long>, IFileBasedFeatureProvider
    {
        ...
        private static void AddFeature(ICollection<IFeature> features, List<Coordinate> coordinates, Envelope envelope)
        {
        ...
        public virtual IEnumerable<IFeature> GetFeatures(Envelope box)
        {
