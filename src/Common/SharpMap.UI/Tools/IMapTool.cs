...
namespace SharpMap.UI.Tools
{
    public interface IMapTool // TODO: IMapControlTool ?
    {
        ...
        void OnMouseDown(Coordinate worldPosition, MouseEventArgs e);
        
        void OnMouseMove(Coordinate worldPosition, MouseEventArgs e);
        
        void OnMouseUp(Coordinate worldPosition, MouseEventArgs e);

        void OnMouseWheel(Coordinate worldPosition, MouseEventArgs e);

        void OnMouseDoubleClick(object sender, MouseEventArgs e);

        void OnMouseHover(Coordinate worldPosition, EventArgs e);
        ...
        void OnBeforeContextMenu(ContextMenuStrip menu, Coordinate worldPosition);
