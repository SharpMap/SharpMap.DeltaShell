...
namespace SharpMap.UI.Tools
{
    ...
    public class LegendTool : LayoutComponentTool
    {
        ...
        public override void OnMouseDown(Coordinate worldPosition, System.Windows.Forms.MouseEventArgs e)
        {
            mouseSelectStart = new Point(-1, -1);
            if (Visible && MapControl.SelectTool.IsActive)
            {
                var bounds = new Rectangle(screenLocation, calculatedSize);
        ...
        public override void OnMouseUp(Coordinate worldPosition, System.Windows.Forms.MouseEventArgs e)
        {
            Selected = mouseSelectStart == e.Location;
        ...
        public override void Render(Graphics graphics, Map mapBox)
        {
            if (Visible)
            {
                ...
                graphics.DrawRectangle(Selected ? Pens.Red : Pens.Black, new Rectangle(screenLocation, newSize));
