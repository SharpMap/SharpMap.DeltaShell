...
namespace SharpMap.UI.Tools
{
    ...
    public class ScaleBarTool : LayoutComponentTool
    {
        ...
        private double GetSegmentInMeters()
        {
            ...
            Coordinate measure0 = Map.ImageToWorld(new PointF(screenLocation.X, screenLocation.Y));
            Coordinate measure1 = Map.ImageToWorld(new PointF(screenLocation.X + size.Width, screenLocation.Y + 1));
