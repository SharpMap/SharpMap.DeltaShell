...
namespace SharpMap.UI.Tools
{
    public class MoveTool : MapTool
    {
        ...
        protected Coordinate LastMouseLocation { get; set; }
        protected Coordinate MouseDownLocation { get; set; }
        ...
        /// <returns></returns>
        private IFeature StartDragging(Coordinate temp, IFeature feature)
        {
