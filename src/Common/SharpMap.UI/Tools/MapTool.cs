...
namespace SharpMap.UI.Tools
{
    ...
    public abstract class MapTool : IMapTool
    {
        ...
        public virtual void OnMouseDown(Coordinate worldPosition, MouseEventArgs e)
        {
        }

        public virtual void OnMouseUp(Coordinate worldPosition, MouseEventArgs e)
        {
        }

        public virtual void OnMouseWheel(Coordinate worldPosition, MouseEventArgs e)
        {
        }

        public virtual void OnMouseMove(Coordinate worldPosition, MouseEventArgs e)
        {
        }
        ...
        public virtual void OnMouseHover(Coordinate worldPosition, EventArgs e)
        {
        }
        ...
        public virtual void OnBeforeContextMenu(ContextMenuStrip menu, Coordinate worldPosition)
        {
        }
        ...
        public Envelope GetEnvelope(Coordinate worldPos, float buffer)
        {
        ...
        public IFeature FindNearestFeature(Coordinate worldPos, float limit, out ILayer outLayer, Func<ILayer, bool> condition)
        {
            ...
            foreach (ILayer mapLayer in Map.GetAllVisibleLayers(true).OrderBy(l => l.RenderOrder))
            {
                ...
                if (mapLayer is VectorLayer)
                {
                    ...
                    {
                        Coordinate size = MapHelper.ImageToWorld(MapControl.Map,
        ...
        public IFeature GetNextFeatureAtPosition(Coordinate worldPos, float limit, out Layer outLayer, IFeature feature,
                                                 Func<ILayer, bool> condition)
        {
            Envelope envelope = GetEnvelope(worldPos, limit);
        ...
        public IGeometry FindNearestGeometry(Coordinate worldPos, float limit, out ILayer nearestLayer,
                                             Func<ILayer, bool> condition)
        {
        ...
        /// <returns></returns>
        private static IFeature FindNearestFeature(VectorLayer vectorLayer, IEnumerable candidates, Coordinate worldPos,
        ...
        /// <returns></returns>
        protected static Coordinate ConvertFromMapToLayer(MapTool mapTool, Coordinate mapCoordinate)
        {
