...
namespace GeoAPI.Extensions.Coverages
{
    ...
    public interface IRegularGridCoverage: ICoverage
    {
        ...
        void Resize(int sizeX, int sizeY, double deltaX, double deltaY,Coordinate origin);

        void Resize(int sizeX, int sizeY, double deltaX, double deltaY, Coordinate origin,bool setComponentValues);
