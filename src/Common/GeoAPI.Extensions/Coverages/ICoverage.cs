...
namespace GeoAPI.Extensions.Coverages
{
    ...
    public interface ICoverage: IFeature, IFunction
    {
        ...
        /// <returns></returns>
        object Evaluate(Coordinate coordinate);
        ...
        /// <param name="coordinate"></param>
        /// <returns></returns>
        T Evaluate<T>(Coordinate coordinate);
        ...
        /// <returns></returns>
        object Evaluate(Coordinate coordinate, DateTime? time);
        ...
        IFunction GetTimeSeries(Coordinate coordinate);
