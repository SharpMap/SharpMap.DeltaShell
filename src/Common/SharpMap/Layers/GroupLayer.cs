...
namespace SharpMap.Layers
{
    ...
    public class GroupLayer : Layer, IGroupLayer//, IDisposable, INotifyCollectionChange
	{
        ...
        protected bool hasReadOnlyLayersCollection;
        private bool isMapInitialized; // performance (lazy initialization)
        private bool cloning;

        public virtual bool HasReadOnlyLayersCollection
        {
            get { return hasReadOnlyLayersCollection; }
            set { hasReadOnlyLayersCollection = value; }
        }
		...
		public override Envelope Envelope
		{
		    get
		    {
		        ...
		        foreach (var layer in Layers.Where(layer => layer.Visible && layer.Envelope != null && !layer.Envelope.IsNull))
		        {
        ...
        public override object Clone()
        {
            ...
            clonedLayerGroup.Name = name.Clone() as string;
            //clonedLayerGroup.HasReadOnlyLayersCollection = false;
            ...
            clonedLayerGroup.HasReadOnlyLayersCollection = HasReadOnlyLayersCollection;
