 ...
 */
        ...
        {
            Envelope boundingBox = GetExtents();
            if (null == boundingBox)
                return;
            boundingBox = (Envelope) boundingBox.Clone();
        ...
        private static void AddMargin(Envelope boundingBox,double percentage)
        {
            double minX = 0.0;
            double minY = 0.0;
        ...
        public virtual void ZoomToFit(Envelope bbox)
        {
        ...
        public virtual void ZoomToFit(Envelope bbox, bool addMargin)
        {
        ...
        public virtual PointF WorldToImage(Coordinate p)
        {
        ...
        public virtual Coordinate ImageToWorld(PointF p)
        {
        ...
        public static ISridCoordinateSystemFactory CoordinateSystemFactory { get; set; }
        public static ICoordinateTransformationFactory CoordinateTransformationFactory { get; set; }
        ...
        private void UpdateLayerCoordinateTransformation(ILayer layer)
        {
            ...
            {
                layer.CoordinateTransformation = (layer.DataSource == null || layer.DataSource.CoordinateSystem == null) 
                    ? null : CoordinateTransformationFactory.CreateFromCoordinateSystems(layer.DataSource.CoordinateSystem, CoordinateSystem);
            }
        }
        ...
        public virtual int SRID
        {
            ...
            set
            {
                ...
                if (CoordinateSystemFactory != null)
                {
                    CoordinateSystem = CoordinateSystemFactory.CreateFromSRID(srid);
                }
            }
        }
        ...
        /// </summary>
        public virtual Coordinate Center
        {
            get { return center; }
            set
            {
                ...
                double dx = value.X - desiredEnvelope.Centre.X;
                double dy = value.Y - desiredEnvelope.Centre.Y;

                desiredEnvelope.Translate(dx, dy);
        ...
        /// </summary>
        private Envelope desiredEnvelope;
