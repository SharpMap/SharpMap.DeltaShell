...
namespace SharpMap.Data.Providers
{
    ...
    public class MsSql : Unique<long>, IFeatureProvider, IFileBased, IDisposable
	{
	    ...
	    public IEnumerable<string> Paths { get {throw new NotImplementedException();} }
		...
		/// <summary>
		/// Spacial Reference in WKT format
		/// </summary>
		...
		private string GetBoxClause(GeoAPI.Geometries.Envelope bbox)
		{
	    ...
	    public IEnumerable<IFeature> GetFeatures(Envelope bbox)
		{
			...
			using (SqlConnection conn = new SqlConnection(connstr))
			{
				...
				foreach (int idx in indexes)
				{
					...
					if (feature.Geometry != null)
					{
						...
						GeoAPI.Geometries.Envelope box = feature.Geometry.EnvelopeInternal;
