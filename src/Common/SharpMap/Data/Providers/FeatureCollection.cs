...
namespace SharpMap.Data.Providers
{
    ...
    public class FeatureCollection : Unique<long>, IFeatureProvider, ITimeNavigatable /* TODO: remove ITimeNavigatable, should be used only on UI facade classes */
    {
        ...
        public virtual Envelope GetBounds(int recordIndex)
        {
        ...
        protected Envelope envelope; // TODO: make it private, currently used to improve performance and still remain robust (clear envelope on change)
        ...
        public virtual Envelope GetExtents()
        {
            ...
            foreach (IFeature feature in Features)
            {
                ...
                if (envelope.IsNull)
                {
                    envelope = (Envelope)feature.Geometry.EnvelopeInternal.Clone();
                }
